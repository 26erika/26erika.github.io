    ...
    return (
      <div className="content">
        ...
        <div className="about">
          ...
          <h4 className="description">I'm a very curious person and I love to learn something new all the time and then share my knowledge, i like draw and i fan of riddles.</h4>
        </div>
